...
public class EmergencyMessagesDatabaseHandler extends SQLiteOpenHelper
{
    private static final int DATABASE_VERSION=1;
    private static final String DATABASE_NAME="Messages.db";
    public static final String TABLE_MESSAGES="Emergency_Messages";
    public static final String COLUMN_ID="_id";
    public static final String COLUMN_TAG="tag";
    public static final String COLUMN_MESSAGE="name";

    public EmergencyMessagesDatabaseHandler(Context context) {
